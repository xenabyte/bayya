                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        ...
                        We are sorry to inform you that the trade going on between you and {{$seller_username}}  on ADS (Order No. {{$merging_id}}) has been cancelled due to trade time expiring
