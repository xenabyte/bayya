              ...
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">
                    ...
                    <h1 style="color:#e7af03">URGENT ATTENTION!</h1>
                    <h2 style="color:#e7af03">KYC Notification</h2>
                ...
                <td>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      A User with username {{ $username }} is waiting on you to approve or reject KYC document.

                      <br><br>
                        Kindly be prompt in responding.
                      <br><br>

                        Thanks for being an Awesome Administrator!<br>
                      </td>
                    </tr>
                  </table>
                </td>
