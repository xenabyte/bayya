        ...
        <div style="color: #444444; line-height: 170%; text-align: justify; word-wrap: break-word;">
          ...
          <p style="font-size: 14px; line-height: 170%;">
            <span style="font-size: 16px; line-height: 27.2px;">
              {{$seller_username}} has agreed to trade with you on trade (Trade No. {{$merging_id}}) you shown interest in.  Please, proceed to make relevant payment for the trade immediately.
            </span>
          </p>
