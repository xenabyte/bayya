        ...
        <div style="color: #444444; line-height: 170%; text-align: justify; word-wrap: break-word;">
          ...
          <p style="font-size: 14px; line-height: 170%;">
            <span style="font-size: 16px; line-height: 27.2px;">
              You have shown an interest in {{$seller_username}} ({{$seller_email}}) Trade of {{ number_format(\App\Http\Controllers\Controller::getCurrencyAmount($currency, $selling_amount)) }} {{ $currency }}. Kindly wait for the seller to review and agree to the terms of trade.
            </span>
          </p>
