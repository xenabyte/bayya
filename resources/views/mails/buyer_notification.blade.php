              ...
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">
                    ...
                    <h2 style="color:#e7af03">Buyer Notification</h2>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        ...
                        You have shown an interest in {{$seller_username}} ({{$seller_email}}) ADS of {{ number_format(\App\Http\Controllers\Controller::getCurrencyAmount($currency, $selling_amount)) }} {{ $currency }}.
                        <br>
                         Kindly wait for the seller to review and agree to the terms of transactions.
                        <br>
