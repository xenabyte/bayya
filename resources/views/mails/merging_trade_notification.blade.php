        ...
        <div style="color: #444444; line-height: 170%; text-align: justify; word-wrap: break-word;">
          ...
          <p style="font-size: 14px; line-height: 170%;">
            <span style="font-size: 16px; line-height: 27.2px;">
              This is to inform you that the trade going on between you and {{$seller_username}} on Trade (Trade No. {{$merging_id}}) will be expiring at {{ $dueDate }}, Kindly be prompt in making payment, and if you have made payment, kindly go to your dashboard, go to trades, locate the trade under ongoing trade, cick on it and click on payment made button.
            </span>
          </p>
