              ...
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">
                    ...
                    <h2 style="color:#e7af03">Seller Notification</h2>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        ...
                        {{$buyer_username}} ({{$buyer_email}}) has shown an interest in your ADS of {{ number_format(\App\Http\Controllers\Controller::getCurrencyAmount($currency, $selling_amount)) }} {{ $currency }}.
                        <br>
                        Kindly proceed to transact with the other party if both parties agrees to the terms and condition of the transaction.
                        <br>
