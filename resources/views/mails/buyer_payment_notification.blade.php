        ...
        <div style="color: #444444; line-height: 170%; text-align: justify; word-wrap: break-word;">
          ...
          <p style="font-size: 14px; line-height: 170%;">
            <span style="font-size: 16px; line-height: 27.2px;">
              {{$buyer_username}} has made payment based on agreed terms on Trade (Trade No. {{$merging_id}}) you placed on the marketplace.  Kindly review the payment and approve, you can raise a dispute if the there is a disparity based on your agreed terms, our dispute manager will review the order.
            </span>
          </p>
