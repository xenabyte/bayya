              ...
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">
                    ...
                    <h2 style="color:#e7af03">Payment Notification</h2>
                ...
                <td>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      {{$buyer_username}} has made payment based on agreed terms on ADS (Order No. {{$merging_id}}) you placed on the marketplace

                      <br><br>

                          Kindly review the payment and approve, you can raise a dispute if the there is a disparity based on your agreed terms, our dispute manager will review the order.
                      <br>
