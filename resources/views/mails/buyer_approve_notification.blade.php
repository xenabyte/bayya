        ...
        <div style="color: #444444; line-height: 170%; text-align: justify; word-wrap: break-word;">
          ...
          <p style="font-size: 14px; line-height: 170%;">
            <span style="font-size: 16px; line-height: 27.2px;">
              {{$seller_username}} has approved your payment based on agreed terms on Trade (Trade No. {{$merging_id}}) you shown interest on the marketplace, Your wallet has be funded with equivalent amount as agreed. Please ensure to drop a review of the other party to help other buyers with transacting with the seller, to do so, login to your dashboard, go to trades, locate the trade under ongoing trade, cick on it, locate the review section.
            </span>
          </p>
