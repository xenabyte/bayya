              ...
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">
                    ...
                    <h2 style="color:#e7af03">Reject Notification</h2>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        ...
                        We are sorry to inform you that {{$seller_username}} does not has the intention to transact on ADS (Order No. {{$merging_id}}) you shown interest on

                        <br><br>

                            Kindly checkout another ADS in the marketplace.
                        <br>
