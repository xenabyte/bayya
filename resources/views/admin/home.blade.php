        ...
        <div class="row mt-n24">
            ...
            <div class="col-6 col-sm-4 col-lg-2 col-md-3 mt-24">
                <div class="widget widget-sm widget-weather-sm h-full">
                    ...
                    <h6 class="widget-degree" style="font-size: 16px">
                        <?php echo $balance ?> BTC <hr> {{ $currency }} {{ number_format($controller::toCurrency($currency, $balance), 2) }}
                    </h6>
                    <h6>Block.IO Balance</h6>
                </div>
            </div>
            ...
            <div class="col-6 col-sm-4 col-lg-2 col-md-3 mt-24">
                <div class="widget widget-sm h-full">
                    ...
                    <h4><span class="counter">{{ $ongoingTrades->count() }}</span></h4>
                    <h6>Ongoing Trades</h6>
                </div>
            </div>
            ...
            <div class="col-6 col-sm-4 col-lg-2 col-md-3 mt-24">
                <div class="widget widget-sm h-full">
                    ...
                    <h4><span class="counter">{{ $user_count }}</span></h4>
                    <h6>All Users</h6>
                </div>
            </div>
            ...
            <div class="col-6 col-sm-4 col-lg-2 col-md-3 mt-24">
                <div class="widget widget-sm h-full">
                    ...
                    <h4><span class="counter">{{$payout_count}}</span></h4>
